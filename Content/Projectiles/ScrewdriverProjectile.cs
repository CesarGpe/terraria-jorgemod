...
{
	public class ScrewdriverProjectile : ModProjectile
	{
		...
		public override void AI() {
			...
			if (playerVelocity > minimumDustVelocity && movementInLanceDirection > 0.8f) {
				...
				int dustTypeCommon = DustID.YellowTorch;
		...
		public override bool? Colliding(Rectangle projHitbox, Rectangle targetHitbox) {
			...
			float scaleFactor = 600f; // How far back the hit-line will be from the tip of the Jousting Lance. You will need to modify this if you have a longer or shorter Jousting Lance. Vanilla uses 95f
			...
			Rectangle lanceHitboxBounds = new Rectangle(1000, 0, 200, 900);
