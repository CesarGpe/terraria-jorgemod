...
namespace eslamio.Content.Items.Pets.DVD;
public class DVDPetItem : ModItem
{
    public override void SetDefaults()
    {
        ...
        Item.buffType = ModContent.BuffType<DVDPetBuff>();
        Item.scale = 0.25f;
    }
...
internal class DVDLogo : UIState
{
    ...
    private Asset<Texture2D> Logo => ModContent.Request<Texture2D>("eslamio/Content/Items/Pets/DVD/DVDPetItem");
