...
namespace eslamio.Content.Items.Pets.Tsuyar;
public class TsuyarPetItem : ModItem
{
    public override void SetDefaults()
    {
        ...
        Item.shoot = ModContent.ProjectileType<TsuyarPetProjectile>();
        Item.buffType = ModContent.BuffType<TsuyarPetBuff>();

        // se consigue fulgoreando la cesar mascota
        ItemID.Sets.ShimmerTransformToItem[ModContent.ItemType<Cesar.CesarPetItem>()] = Type;
    }
...
public class TsuyarPetBuff : BasePetBuff
{
    protected override int PetProj => ModContent.ProjectileType<TsuyarPetProjectile>();
}

public class TsuyarPetProjectile : ModProjectile
{
    public override string Texture => "eslamio/Content/Items/Pets/Tsuyar/TsuyarPetItem";
