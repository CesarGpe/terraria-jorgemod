...
namespace eslamio.Content.Items.Pets.Cesar;
public class CesarPetItem : ModItem
{
    public override void SetDefaults()
    {
        Item.CloneDefaults(ItemID.ZephyrFish);

        Item.shoot = ModContent.ProjectileType<CesarPetProjectile>();
        Item.buffType = ModContent.BuffType<CesarPetBuff>();

        // ping pong
        ItemID.Sets.ShimmerTransformToItem[ModContent.ItemType<Tsuyar.TsuyarPetItem>()] = Type;
    }
...
public class CesarPetBuff : BasePetBuff
{
    protected override int PetProj => ModContent.ProjectileType<CesarPetProjectile>();
}

public class CesarPetProjectile : ModProjectile
{
    public override string Texture => "eslamio/Content/Items/Pets/Cesar/CesarPetItem";
