...
namespace eslamio.Content.Items.Consumables
{
	...
	public class JorgeBossSummonItem : ModItem
	{
		...
		public override bool? UseItem(Player player) {
			if (player.whoAmI == Main.myPlayer) {
				...
				int type = ModContent.NPCType<JorgeBoss>();
		...
		public override void AddRecipes() {
			CreateRecipe()
				.AddIngredient(ItemID.Gel, 3200)
				.AddIngredient(ItemID.PoopBlock, 32000)
				.AddTile(TileID.Toilets)
				.Register();
		}
	}
}